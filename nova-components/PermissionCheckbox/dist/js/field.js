...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-permission-checkbox', __webpack_require__(5));
  Vue.component('detail-permission-checkbox', __webpack_require__(8));
  Vue.component('form-permission-checkbox', __webpack_require__(14));
});
      ...
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "w-full mb-4" }, [
          ...
          _c(
            "span",
            {
              staticClass: "ml-auto btn btn-default btn-danger",
              staticStyle: { cursor: "pointer" },
              on: {
                click: function($event) {
