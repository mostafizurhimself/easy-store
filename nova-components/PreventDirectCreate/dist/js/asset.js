...
Nova.booting(function (Vue, router, store) {
    ...
    router.beforeEach(function (to, from, next) {
        if (to.path === "/resources/fabric-purchase-items/new" && (to.query.viaResource != 'fabric-purchase-invoices' || to.query.viaResourceId == null)) {
    ...
    router.beforeEach(function (to, from, next) {
        if (to.path === "/resources/fabric-transfer-items/new" && (to.query.viaResource == null || to.query.viaResourceId == null)) {
            router.push({ name: "403" });
    ...
    router.beforeEach(function (to, from, next) {
        if (to.path === "/resources/fabric-transfer-receive-items/new" && (to.query.viaResource == null || to.query.viaResourceId == null)) {
            router.push({ name: "403" });
    ...
    router.beforeEach(function (to, from, next) {
        if (to.path === "/resources/material-transfer-items/new" && (to.query.viaResource == null || to.query.viaResourceId == null)) {
            router.push({ name: "403" });
    ...
    router.beforeEach(function (to, from, next) {
        if (to.path === "/resources/material-transfer-receive-items/new" && (to.query.viaResource == null || to.query.viaResourceId == null)) {
            router.push({ name: "403" });
    ...
    //Asset Section
    router.beforeEach(function (to, from, next) {
        if (to.path === "/resources/asset-purchase-items/new" && (to.query.viaResource != 'asset-purchase-invoices' || to.query.viaResourceId == null)) {
            router.push({ name: "403" });
