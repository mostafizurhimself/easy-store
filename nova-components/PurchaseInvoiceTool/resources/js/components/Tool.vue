<template>
    <div>
        <heading class="mb-6">Asset Purchase Invoice</heading>
                ...
                <div class="row">
                    <div class="col">
                        <a target="_blank" href="#">
                            <img src="../../../../../public/images/logo.jpg" data-holder-rendered="true" width="100px" />
                            </a>
                    </div>
                    <div class="col company-details">
                        ...
                        <div>1, DIT Road, Hazipara</div>
                        <div>01834507645</div>
                        <div>easyfashionwears@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
