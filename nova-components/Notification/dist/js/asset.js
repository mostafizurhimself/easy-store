...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_infinite_loading__ = __webpack_require__(10);
      ...
      _c(
        ...
        [
          _c("notification-panel", {
            ...
            on: { toggleNotificationsPanel: _vm.toggleNotificationsPanel }
          })
        ],
        1
      )
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6be3a47e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/NotificationPanel.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6be3a47e", Component.options)
  } else {
    hotAPI.reload("data-v-6be3a47e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [_c("div", [_vm._v("Notification Messages")])]
    )
  }
]
render._withStripped = true
