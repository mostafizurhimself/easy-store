...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{Settings::applicationLogo() ?? asset('images/logo.jpg')}}" type="image/gif" sizes="16x16">
            ...
            <div class="content">
                <div class="flex items-center relative shadow h-header bg-white z-20 px-view">
                    ...
                    @if (Settings::application())
                        <a  href="{{ \Illuminate\Support\Facades\Config::get('nova.url') }}" class="no-underline dim font-bold text-90 mr-6">
                    ...
                    <dropdown class="h-9 flex items-center dropdown-right" style="margin-left: 30px">
