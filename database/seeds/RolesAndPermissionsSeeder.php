...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $collection = collect([
            ...
            ['name' => 'asset transfer orders', 'order' => 36],
            ['name' => 'asset transfer items', 'order' => 37],
            ['name' => 'service categories', 'order' => 41],
            ['name' => 'services', 'order' => 42],
            ['name' => 'service dispatch invoices', 'order' => 43],
            ['name' => 'service dispatches', 'order' => 44],
            ['name' => 'service receives', 'order' => 45],
            ...
            ['name' => 'expenser_balances', 'order' => 61],
            ['name' => 'expenser_expenses', 'order' => 62],
