...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $expenser->givePermissionTo([
            'view expensers', 'view any expensers', 'view expense categories', 'view any expense categories', 'view expenses',
