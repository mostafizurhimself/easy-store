...
class AssetDistributionReceiveItemObserver
{
    ...
    public function saving(AssetDistributionReceiveItem $assetDistributionReceiveItem)
    {
        ...
        if(empty($assetDistributionReceiveItem->unitId)){

            $assetDistributionReceiveItem->unitId = $asset->unitId;
        }
        //Set Amount
        $assetDistributionReceiveItem->amount = $assetDistributionReceiveItem->rate * $assetDistributionReceiveItem->quantity;
    }
