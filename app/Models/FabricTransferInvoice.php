...
class FabricTransferInvoice extends Model implements HasMedia
{
    ...
    /**
     * Get the transfer fabrics ids as an array
     *
     * @return array
     */
    public function fabricIds($id = null)
    {
        return $this->transferItems->whereNotIn('fabric_id', [$id])->pluck('fabric_id')->toArray();
    }

    /**
     * Scope a query to only include draft transfer.
     *
