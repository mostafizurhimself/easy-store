...
class MaterialPurchaseItemExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    /**
     * @var collection
     */
    ...
    {
        return view('excel.pages.material-purchase-items')->with('models', $this->models);
    }
