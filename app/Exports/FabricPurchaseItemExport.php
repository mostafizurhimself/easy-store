...
class FabricPurchaseItemExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    /**
     * @var collection
     */
    ...
    {
        return view('excel.pages.fabric-purchase-items')->with('models', $this->models);
    }
