...
namespace App\Nova\Actions\Materials\StockSummary;
...
class DownloadPdf extends Action
{
    ...
    {
        $filename = "materials_stock_summary_".time().".pdf";
        $subtitle = $fields->subtitle;

        ini_set("pcre.backtrack_limit", "10000000000");
        $pdf = \PDF::loadView('pdf.pages.material-stock-summaries', compact('models', 'subtitle'), [], [
            'mode' => 'utf-8',
            'orientation' => 'L'
        ]);
